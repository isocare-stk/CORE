...
{
    public partial class u_cri_coopid_period_membno : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            ...
            string as_smembno = dsMain.DATA[0].start_empno;
            string as_emembno = dsMain.DATA[0].end_empno;
            ...
            try
            {
                ...
                arg.Add("as_memno", iReportArgumentType.String, as_smembno);
                arg.Add("as_ememno", iReportArgumentType.String, as_emembno);

...
namespace Saving.CriteriaIReport.u_cri_coopid_date_resign
{
    public partial class u_cri_coopid_date_resign : PageWebReport, WebReport
    {
        ...
        public void RunReport()
        {
            try
            {
                ...
                string as_resign_sstatus = resign_sstatus.Text;
                string as_resign_estatus = resign_estatus.Text;
                ...
                arg.Add("as_resign_sstatus", iReportArgumentType.String, as_resign_sstatus);
                arg.Add("as_resign_estatus", iReportArgumentType.String, as_resign_estatus);

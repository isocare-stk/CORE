        ...
        private void InitLnRcv()
        {
            try
            {
                ...
                if (mType == "")
                {
                    ...
                    //dsMain.DATA[0].MONEYTYPE_CODE = "TRN"; // อั้ม เพิ่มชั่วคราวให้พี่เล็กทำจ่ายปันผลก่อนถ้าเสร็จเเล้วจะกลับไปเปิด CSH เหมือนเดิม
                }
            ...
            //dsMain.DATA[0].TOFROM_ACCID = "30030401"; // อั้ม เพิ่มชั่วคราวให้พี่เล็กทุนสวัสดิการ
        }

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.deposit.ws_dep_editinttax_ctrl.DsMain" %>
        ...
        <table class="DataSourceFormView" width="700px" >
            <tr>
                ...
                <td width="20%" rowspan="3">
                    <asp:Button ID="b_search" Text="ค้นหา" runat="server" Style="width:90%;height:80px" />
                </td>
            </tr>            
            <tr>
                <td>

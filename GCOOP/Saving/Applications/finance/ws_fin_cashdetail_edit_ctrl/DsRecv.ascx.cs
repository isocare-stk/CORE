...
{
    public partial class DsRecv : DataSourceRepeater
    {
        public DataSet1.FINTABLEUSERDETAILDataTable DATA { get; set; }

        public void InitDsRecv(PageWeb pw)
        {
            css1.Visible = false;
            DataSet1 ds = new DataSet1();
            this.DATA = ds.FINTABLEUSERDETAIL;
            this.EventItemChanged = "OnDsRecvItemChanged";
            this.EventClicked = "OnDsRecvClicked";
            this.InitDataSource(pw, Repeater1, this.DATA, "dsRecv");
